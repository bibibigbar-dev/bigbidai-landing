...
<section class="section" id="faq"><div class="wrap faq"><div><div class="eyebrow">FAQ</div><h2>Questions before your first lot?</h2><p class="muted">bigbid AI is focused on making high-volume reseller and auction inventory easier to process.</p><a class="btn primary" href="#pricing">Try for Free</a></div><div class="faq-list">
  ...
  <div class="faq-item"><button class="faq-q" id="faq-q-6" aria-expanded="false" aria-controls="faq-a-6">What happens after the first 10 items?<span>+</span></button><div class="faq-a" id="faq-a-6" aria-labelledby="faq-q-6" hidden>Choose the Basic, Pro or Custom plan based on your monthly item volume and workflow needs.</div></div>
</div></div></section>
